    ...
    const sameDayEvent = () => {
      eventsData.forEach((data) => {
        if (date.value == data.date) {
          // fix
          console.log('aaa', eventsData.indexOf(data))
          return eventsData.indexOf(data)
        } else if (date.value == data.newDate) {
          return eventsData.indexOf(data.newDate)
        } else if (date.value == data.new3Date) {
          return eventsData.indexOf(data.new3Date)
        } else if (date.value == data.new4Date) {
          return eventsData.indexOf(data.new4Date)
        } else if (date.value == data.new5Date) {
          return eventsData.indexOf(data.new5Date)
        }
      })
    }
